  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-5"
        style={{
          backgroundImage: "radial-gradient(circle at 2px 2px, rgba(0,174,219,1) 1px, transparent 0)",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`mb-12 lg:mb-16 ${isAr ? "text-right" : "text-left"}`}>
          <div className={`flex items-center gap-3 mb-4 ${isAr ? "justify-end flex-row-reverse" : ""}`}>
          ...
          {content.services.map((service, idx) => (
            ...
            >
              ...
              <div className={`p-5 flex-1 flex flex-col ${isAr ? "text-right" : "text-left"}`}>
                ...
                <div className="mt-4 h-0.5 w-0 bg-gradient-to-r from-brand-500 to-accent
